...
part1 = """// Code generated by "./test.py generate"; DO NOT EDIT.
...
def generate():
    with open('apigen_test.go', 'w') as f:
        ...
        if 'disasm' in opt:
            print(
                f'\t\t\tInterpret([]byte(tc.input), OptOutput(b), OptDisasm(tc.disasm))',
                file=f,
            )
        else:
            print(f'\t\t\tInterpret([]byte(tc.input), OptOutput(b))', file=f)
        print(part3, file=f)
