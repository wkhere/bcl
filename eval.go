...
func eval(top *nTop) error {
	...
	fmt.Println("evaled vars:", env.varVals) //tmp
	return nil
}
...
type errNoVarDef nIdent
type errNoVarVal nVarRef
...
func (e errNoVarDef) Error() string {
	return fmt.Sprintf("var %s not defined", string(e))
}
func (e errNoVarVal) Error() string {
	return fmt.Sprintf("var %s not evaluated", string(e))
}
