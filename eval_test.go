...
var evalTab = []evaltc{
	...
	// 50
	evalid(`var x= 1==1  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1==2  blk "b" {x=x}`, xfalse),
	evalid(`var x= 1!=1  blk "b" {x=x}`, xfalse),
	evalid(`var x= 1!=2  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1==1.0   blk "b" {x=x}`, xtrue),
	// 55
	evalid(`var x= 1.0==1   blk "b" {x=x}`, xtrue),
	evalid(`var x= 1.0!=1   blk "b" {x=x}`, xfalse),
	evalid(`var x= 1!=1.0   blk "b" {x=x}`, xfalse),
	evalid(`var x= 1.0==1.0 blk "b" {x=x}`, xtrue),
	evalid(`var x= 1.0!=1.0 blk "b" {x=x}`, xfalse),
	// 60
	...
	eerror(`var x= "s"!=1`, `invalid types: string, int`),
	// 65
	evalid(`var x= ""==""   blk "b" {x=x}`, xtrue),
	evalid(`var x= "a"=="a" blk "b" {x=x}`, xtrue),
	evalid(`var x= "a"=="b" blk "b" {x=x}`, xfalse),
	evalid(`var x= "a"==""  blk "b" {x=x}`, xfalse),
	evalid(`var x= ""=="a"  blk "b" {x=x}`, xfalse),
	// 70
	evalid(`var x= 1.0!=1.0 blk "b" {x=x}`, xfalse),
	evalid(`var x= 1.0!=1.2 blk "b" {x=x}`, xtrue),
	evalid(`var x= ""!=""   blk "b" {x=x}`, xfalse),
	evalid(`var x= "a"!="a" blk "b" {x=x}`, xfalse),
	evalid(`var x= "a"!="b" blk "b" {x=x}`, xtrue),
	// 75
	evalid(`var x= true==true blk "b" {x=x}`, xtrue),
	evalid(`var x= true==false blk "b" {x=x}`, xfalse),
	evalid(`var x= true==(1==1)  blk "b" {x=x}`, xtrue),
	evalid(`var x= (1==1)==true  blk "b" {x=x}`, xtrue),
	evalid(`var x= (1==1)==(2==2)  blk "b" {x=x}`, xtrue),
	// 80
	evalid(`var x= true!=false  blk "b" {x=x}`, xtrue),
	evalid(`var x= true!=true  blk "b" {x=x}`, xfalse),
	evalid(`var x= true!=(1!=1)  blk "b" {x=x}`, xtrue),
	evalid(`var x= (1==1)!=(2==2)  blk "b" {x=x}`, xfalse),
	evalid(`var x= (1==1)!=(2!=2)  blk "b" {x=x}`, xtrue),
	// 85
	evalid(`var x= 1<2  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1>2  blk "b" {x=x}`, xfalse),
	evalid(`var x= 2>1  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1<=1 blk "b" {x=x}`, xtrue),
	evalid(`var x= 1<=2 blk "b" {x=x}`, xtrue),
	// 90
	evalid(`var x= 1>=1 blk "b" {x=x}`, xtrue),
	evalid(`var x= 2>=1 blk "b" {x=x}`, xtrue),
	evalid(`var x= 1<2.0  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1.0<2  blk "b" {x=x}`, xtrue),
	evalid(`var x= 2>1.0  blk "b" {x=x}`, xtrue),
	// 95
	evalid(`var x= 2.0>1  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1.0<2.0  blk "b" {x=x}`, xtrue),
	evalid(`var x= 2.0>1.0  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1<=1.0  blk "b" {x=x}`, xtrue),
	evalid(`var x= 1<=2.0  blk "b" {x=x}`, xtrue),
	// 100
	evalid(`var x= 1.0<=1  blk "b" {x=x}`, xtrue),
	...
	// 110
	evalid(`var x= "a"<"b"  blk "b" {x=x}`, xtrue),
	evalid(`var x= "b">"a"  blk "b" {x=x}`, xtrue),
	evalid(`var x= "a"<="a" blk "b" {x=x}`, xtrue),
	evalid(`var x= "a"<="b" blk "b" {x=x}`, xtrue),
	evalid(`var x= "b">="b" blk "b" {x=x}`, xtrue),
	// 115
	evalid(`var x= "b">="a" blk "b" {x=x}`, xtrue),
