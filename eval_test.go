...
var evalTab = []evaltc{
	...
	evalid(`var x= 1!=1  blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	...
	evalid(`var x= 1.0!=1   blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= 1!=1.0   blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= 1.0==1.0 blk "b" {x=x}`, bb{{"blk", "b", emap{"x": true}}}),
	evalid(`var x= 1.0!=1.0 blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	// 60
	...
	eerror(`var x= "s"!=1`, `invalid types: string, int`),
	// 65
	evalid(`var x= ""==""   blk "b" {x=x}`, bb{{"blk", "b", emap{"x": true}}}),
	evalid(`var x= "a"=="a" blk "b" {x=x}`, bb{{"blk", "b", emap{"x": true}}}),
	evalid(`var x= "a"=="b" blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= "a"==""  blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= ""=="a"  blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	// 70
	evalid(`var x= 1.0!=1.0 blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= 1.0!=1.2 blk "b" {x=x}`, bb{{"blk", "b", emap{"x": true}}}),
	evalid(`var x= ""!=""   blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= "a"!="a" blk "b" {x=x}`, bb{{"blk", "b", emap{"x": false}}}),
	evalid(`var x= "a"!="b" blk "b" {x=x}`, bb{{"blk", "b", emap{"x": true}}}),
	// 75
	evalid(`var x= true==true blk "b" {x=x}`,
		bb{{"blk", "b", emap{"x": true}}},
	),
	evalid(`var x= true==false blk "b" {x=x}`,
		bb{{"blk", "b", emap{"x": false}}},
	),
	evalid(`var x= true==(1==1)  blk "b" {x=x}`,
		bb{{"blk", "b", emap{"x": true}}},
	),
	evalid(`var x= (1==1)==true  blk "b" {x=x}`,
		bb{{"blk", "b", emap{"x": true}}},
	),
